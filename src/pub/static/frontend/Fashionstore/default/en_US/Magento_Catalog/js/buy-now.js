define([
	...
	return function (config, element) {
		...
		function bindShareModal() {
			var namespace = '.fashionstoreShare';
			...
			if (!$form.find('[data-role="share-wrap"]').length) {
				return;
			}

			$form.off('click' + namespace, '[data-role="share-toggle"]');
			$form.off('click' + namespace, '[data-role="share-close"], [data-role="share-close-btn"]');
			$form.off('click' + namespace, '[data-role="share-modal-dialog"]');
			$(document).off('keydown' + namespace);

			$form.on('click' + namespace, '[data-role="share-toggle"]', function (event) {
			...
			$form.on('click' + namespace, '[data-role="share-close"], [data-role="share-close-btn"]', function (event) {
				event.preventDefault();
				closeAllShareModal();
			});

			$form.on('click' + namespace, '[data-role="share-modal-dialog"]', function (event) {
				event.stopPropagation();
			});
