define([
    ...
    var methodConfig = {
        vnpay: {
            badge: 'Gateway',
            description: 'Thanh toan VNPAY redirect den trang QR sandbox.',
        ...
        fashionstore_zalopay: {
            badge: 'Wallet',
            description: 'Thanh toan voi ZaloPay qua QR, lien ket ngan hang va vi dien tu.',
            icon: require.toUrl('FashionStore_CartOptions/images/payment-zalopay.svg'),
            modifier: 'zalopay'
        },
